...
public abstract class Hilt_EarnCoinFragment extends RewardBaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EarnCoinFragment_GeneratedInjector) this.generatedComponent()).injectEarnCoinFragment(UnsafeCasts.<EarnCoinFragment>unsafeCast(this));
    }
  }

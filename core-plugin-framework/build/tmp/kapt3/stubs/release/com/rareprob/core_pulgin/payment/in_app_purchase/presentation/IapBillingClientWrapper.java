...
public final class IapBillingClientWrapper implements com.android.billingclient.api.PurchasesUpdatedListener, com.android.billingclient.api.ProductDetailsResponseListener {
    ...
    private final kotlinx.coroutines.flow.MutableStateFlow<com.rareprob.core_pulgin.payment.in_app_purchase.data.model.PurchaseRestoreState> _isPurchasedRestored = null;
    @org.jetbrains.annotations.NotNull()
    ...
    java.util.List<com.rareprob.core_pulgin.payment.in_app_purchase.data.model.ProductListingData> rcProductItemList, boolean isPurchaseRestoreCall) {
    }

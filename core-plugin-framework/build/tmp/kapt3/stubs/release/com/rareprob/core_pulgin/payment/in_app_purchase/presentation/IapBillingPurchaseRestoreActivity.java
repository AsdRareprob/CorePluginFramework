...
public final class IapBillingPurchaseRestoreActivity extends com.rareprob.core_pulgin.core.base.CoreBaseActivity {
    ...
    public static final com.rareprob.core_pulgin.payment.in_app_purchase.presentation.IapBillingPurchaseRestoreActivity.Companion Companion = null;
    ...
    private final com.rareprob.core_pulgin.payment.in_app_purchase.presentation.IapBillingPurchaseRestoreActivity.Params getParams() {
        return null;
    }
    ...
    public static final class Params implements android.os.Parcelable {
        ...
        public static final android.os.Parcelable.Creator<com.rareprob.core_pulgin.payment.in_app_purchase.presentation.IapBillingPurchaseRestoreActivity.Params> CREATOR = null;
        
        @org.jetbrains.annotations.NotNull()
        public final com.rareprob.core_pulgin.payment.in_app_purchase.presentation.IapBillingPurchaseRestoreActivity.Params copy(@org.jetbrains.annotations.NotNull()
        ...
        public static final class Creator implements android.os.Parcelable.Creator<com.rareprob.core_pulgin.payment.in_app_purchase.presentation.IapBillingPurchaseRestoreActivity.Params> {
            ...
            @org.jetbrains.annotations.NotNull()
            @java.lang.Override()
            public final com.rareprob.core_pulgin.payment.in_app_purchase.presentation.IapBillingPurchaseRestoreActivity.Params createFromParcel(@org.jetbrains.annotations.NotNull()
            ...
            @org.jetbrains.annotations.NotNull()
            @java.lang.Override()
            public final com.rareprob.core_pulgin.payment.in_app_purchase.presentation.IapBillingPurchaseRestoreActivity.Params[] newArray(int size) {
                return null;
            }
        }
    }
    ...
    public static final class Companion {
        ...
        com.rareprob.core_pulgin.payment.in_app_purchase.presentation.IapBillingPurchaseRestoreActivity.Params params) {
        }
        
        private final android.content.Intent getLaunchIntent(android.content.Context context, com.rareprob.core_pulgin.payment.in_app_purchase.presentation.IapBillingPurchaseRestoreActivity.Params params) {
            return null;
        }
    }
}